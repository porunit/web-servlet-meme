...
public class NotFoundFilter implements Filter {
    ...
    private final List<String> paths = Arrays.asList("/pensil/", "/pensil/control", "/pensil/index.jsp", "/pensil/error.jsp", "/pensil/result_page.jsp", "/pensil/table.jsp", "/pensil/access_error.jsp");
